...
public:
  ...
  simple_target_socket<InterconnectProtocol> interconnect0_target_socket;
  simple_initiator_socket<InterconnectProtocol> interconnect0_initiator_socket;
  simple_target_socket<InterconnectProtocol> interconnect1_target_socket;
  simple_initiator_socket<InterconnectProtocol> interconnect1_initiator_socket;
...
private:
  ...
  tlm_sync_enum nb_transport_fw_interconnect0(
      tlm_generic_payload & transaction, tlm_phase & phase, sc_time & delay);

  tlm_sync_enum nb_transport_fw_interconnect1(
      tlm_generic_payload & transaction, tlm_phase & phase, sc_time & delay);
