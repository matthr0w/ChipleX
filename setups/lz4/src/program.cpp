       ...
       {CPUCode{
           .main =
               [](Core &core) {
                 ...
                 auto reqw = AxiRequest(0, write_buf, str.length() + 1)
           ...
           .irq =
               [](Core &core, const IRQ &irq) {
                 ...
                 const int total_size =
                     sizeof(DataHeader) + compressed_data_size;
                 ...
                 auto reqw = AxiRequest(0, packet, total_size)
       ...
       {CPUCode{
           ...
           .irq =
               [](Core &core, const IRQ &irq) {
                 ...
                 auto reqw = AxiRequest(0, decompressed_data, decompressed_size)
