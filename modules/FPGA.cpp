...
FPGA::FPGA(sc_module_name name)
    : sc_module(name), core("Core", 0, 0, chiplet_ram_size, fpga_ram_size,
                            interconnect_irq_delay),
      cache("Cache", 0, fpga_cache_size, fpga_cache_block_size,
            fpga_cache_arbitration_delay, fpga_cache_access_delay,
            fpga_bus_width, fpga_bus_clk_cycle),
      bus("Bus", 0, 2, 2, fpga_bus_arbitration_delay),
      interconnectprotocol("InterconnectProtocol", 0, 1, num_chiplets,
                           interconnect_flit_size, interconnect_overhead_size,
                           interconnect_pre_delay, interconnect_post_delay,
                           interconnect_irq_delay, fpga_bus_width,
                           fpga_bus_clk_cycle),
