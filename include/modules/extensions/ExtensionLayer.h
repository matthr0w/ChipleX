...
SC_MODULE(ExtensionLayer), public DMAForwardInterface {
  ...
  public:
    ...
    ExtensionLayer(sc_module_name name, ChipletConfig chiplet_config, DMAEngine * dma_engine);
    ~ExtensionLayer();
  ...
  public:
    ...
    // Transport Functions
    // -------------------------------------------------------
    tlm_sync_enum nb_transport_fw_up(ARM::AXI::Payload & payload, ARM::AXI::Phase & phase);
    tlm_sync_enum nb_transport_bw_up(ARM::AXI::Payload & payload, ARM::AXI::Phase & phase);
    tlm_sync_enum nb_transport_fw_down(ARM::AXI::Payload & payload, ARM::AXI::Phase & phase);
    tlm_sync_enum nb_transport_bw_down(ARM::AXI::Payload & payload, ARM::AXI::Phase & phase);
    // DMA engine
