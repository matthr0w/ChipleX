...
struct DMAForwardInterface {
	virtual tlm_sync_enum nb_transport_bw_axi(ARM::AXI::Payload &payload, ARM::AXI::Phase &phase) = 0;
...
SC_MODULE(DMAEngine) {
  ...
  public:
	...
	bool forward_from_virtual(int vm_id, ARM::AXI::Payload &payload, ARM::AXI::Phase phase);
};