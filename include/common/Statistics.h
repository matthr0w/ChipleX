...
class StatManager {
  public:
	...
	StatCounter     *register_counter(const std::string &module, const std::string &name);
	StatAccum       *register_accum(const std::string &module, const std::string &name);
	StatMinMax      *register_minmax(const std::string &module, const std::string &name);
	StatUsage       *register_usage(const std::string &module, const std::string &name);
	StatUtilization *register_utilization(const std::string &module, const sc_time clk_cycle = sc_time(0, SC_NS));
	StatUtilization *register_utilization(const std::string &module, const std::string &name,
	                                      const sc_time clk_cycle = sc_time(0, SC_NS));

	void set_value(const std::string &module, const std::string &name, double value);
	void increment_counter(const std::string &module, const std::string &name, uint64_t value = 1);
	void update_accum(const std::string &module, const std::string &name, double value);
	void update_minmax(const std::string &module, const std::string &name, double value);
	void update_usage(const std::string &module, const std::string &name, unsigned value);
	...
	void add_active_time(const std::string &module, const sc_time delta = sc_time(0, SC_NS));
	void add_active_time(const std::string &module, const std::string &name, const sc_time delta = sc_time(0, SC_NS));
	void add_idle_time(const std::string &module, const sc_time delta = sc_time(0, SC_NS));
	void add_idle_time(const std::string &module, const std::string &name, const sc_time delta = sc_time(0, SC_NS));
	void mark_active_cycle(const std::string &module, double fraction = 1.0);
	void mark_active_cycle(const std::string &module, const std::string &name, double fraction = 1.0);
  ...
  private:
	...
	std::unordered_map<std::string, std::unordered_map<std::string, std::unique_ptr<StatBase>>> module_stats_;
